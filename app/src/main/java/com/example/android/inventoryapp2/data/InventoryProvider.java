...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (priceProduct != null && priceProduct < 0) {
            throw new IllegalArgumentException("Valid Product price required");
        }
        ...
        if (quantityProduct != null && quantityProduct < 0) {
            throw new IllegalArgumentException("Valid Product quantity required");
        }
        ...
        if (supplierPhone != null && supplierPhone < 0) {
            throw new IllegalArgumentException("Valid Supplier Phone required");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryEntry.COLUMN_PRODUCT_PRICE)) {
            ...
            if (priceProduct != null && priceProduct < 0) {
                throw new
                        IllegalArgumentException("Valid Product price required");
            }
        }
        ...
        if (values.containsKey(InventoryEntry.COLUMN_PRODUCT_QUANTITY)) {
            ...
            if (quantityProduct != null && quantityProduct < 0) {
                throw new
                        IllegalArgumentException("Valid Product quantity required");
            }
        }
        ...
        if (values.containsKey(InventoryEntry.COLUMN_PRODUCT_SUPPLIER_PHONE_NUMBER)) {
            ...
            if (supplierPhone != null && supplierPhone < 0) {
                throw new
                        IllegalArgumentException("Valid Supplier Phone required");
            }
        }
